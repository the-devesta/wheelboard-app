                  ...
                  child: Center(
                    child: Text(
                      ...
                      style: GoogleFonts.poppins(
                        ...
                        color: _isYearly ? const Color(0xFF6B7280) : Colors.white,
                      ),
                    ),
                  ),
                ),
                  ...
                  child: Center(
                    child: Text(
                      ...
                      style: GoogleFonts.poppins(
                        fontSize: 15,
                        fontWeight: FontWeight.w600,
                        color: _isYearly ? Colors.white : const Color(0xFF6B7280),
                      ),
                    ),
                  ),
                ),
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: Colors.white,
            border: Border.all(
              color: isRecommended ? const Color(0xFF407BFF) : const Color(0xFFE5E7EB),
      ...
      child: Column(
        children: [
          ...
          _buildFAQItem(
            ...
            answer: 'Yes, yearly subscriptions come with a 20% discount compared to monthly billing.',
          ),
          const SizedBox(height: 24),
          _buildFAQItem(
          ...
          _buildFAQItem(
            ...
            answer: 'All plans include customer support. Pro and Enterprise plans get priority and dedicated support respectively.',
          ),
        ],
      ),
    );
