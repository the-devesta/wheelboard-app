...
import '../Professional/MyLearning/learning_detail_screen.dart';

// Design tokens — match SP home & Professional learning
...
/// Service Provider "Learning" screen — mirrors `/business/learning` on web.
///
/// Reuses the same [LearningService] and [LearningDetailScreen] as the
/// Professional role — only the header branding differs.
class SpLearningScreen extends StatefulWidget {
  const SpLearningScreen({super.key});

  @override
  State<SpLearningScreen> createState() => _SpLearningScreenState();
}

class _SpLearningScreenState extends State<SpLearningScreen> {
          ...
          child:
            ...
            Text('Learning Hub',
                style: GoogleFonts.poppins(
                    ...
                    color: _textDark)),
            Text('Grow your business skills',
                style:
                    GoogleFonts.poppins(fontSize: 12, color: _textGrey)),
          ]),
        ),
      ]),
    );
  ...
  Widget _searchBar() {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon:
            const Icon(Iconsax.search_normal_1, size: 18, color: _textGrey),
        filled: true,
        fillColor: _card,
        isDense: true,
